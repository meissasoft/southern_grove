		...
		if ( $twitter_api->hasUserConnected() ) {
			...
			if ( $response->status ) {
				if ( is_array( $response->data ) && count( $response->data ) ) { ?>
                    <ul class="qodef-twitter-widget <?php echo esc_attr( $holder_classes ); ?>" <?php echo bazaar_qodef_get_inline_attrs( $slider_data ); ?>>
						<?php foreach ( $response->data as $tweet ) { ?>

							<?php if ( $type_of_widget == 'slider' ) { ?>

                                <li class="qodef-tweet-holder">
                                    <div class="qodef-tweet-text" <?php bazaar_qodef_inline_style( $twitter_style ); ?>>
